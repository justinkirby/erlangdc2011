...
* What webmachine is
  ...
  - Makes the complex http state machine digestable
  - Easy to do it right.
...
* Resource
  ...
  a http fsm. you write functions to handle various states

* Request

  data from the client, it is a record. use the wrq module to access it

* Response

  the data you send back, use wrq to set that data
